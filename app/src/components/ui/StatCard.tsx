...
/**
 * A KPI / stat display card used on Dashboard and Statistics pages.
...
export default function StatCard({
	...
	return (
		<div
			className={`rounded-2xl border border-slate-100 bg-white p-5 shadow-sm ${wide ? 'col-span-2 sm:col-span-1' : ''} ${icon ? 'flex items-start gap-4' : 'flex flex-col justify-between'} ${className}`.trim()}
		>
			{icon && (
