							...
							>
								...
								{useReactSelect ? (
									<Select<CategoryOption, false>
										...
										onMenuClose={() => { setOpenCategoryRow((prev) => (prev === rowIdx ? null : prev)); setCategorySearchInput(''); }}
										...
										onChange={(option) => { updateCategory(rowIdx, option?.value ?? ''); setOpenCategoryRow(null); setCategorySearchInput(''); }}
